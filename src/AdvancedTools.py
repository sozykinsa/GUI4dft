...
class TCap(TAtomicModel):
    ...
    def __init__(self, n, m):
        ...
        cap_atoms.add_atom(TAtom([-0.36693112712E+00, 0.14828478339E+01, 1.86168451, "C", 6, False]))
        cap_atoms.add_atom(TAtom([-0.14123318617E+01, 0.42721410070E+00, 1.88297428, "C", 6, False]))
        cap_atoms.add_atom(TAtom([-0.10568038810E+01, -0.10057307755E+01, 1.82796005, "C", 6, False]))
        cap_atoms.add_atom(TAtom([0.38589540659E+00, -0.13267764277E+01, 1.84106985, "C", 6, False]))
