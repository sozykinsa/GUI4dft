...
def model_to_qe_pw(model: AtomicModel):
    ...
    text += str(model.lat_vector1[0]) + " " + str(model.lat_vector1[1]) + " " + str(model.lat_vector1[2]) + "\n"
    text += str(model.lat_vector2[0]) + " " + str(model.lat_vector2[1]) + " " + str(model.lat_vector2[2]) + "\n"
    text += str(model.lat_vector3[0]) + " " + str(model.lat_vector3[1]) + " " + str(model.lat_vector3[2]) + "\n"
    text += "ATOMIC_SPECIES\n"
