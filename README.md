...
## Code testing
Automatic code testing (pytest) is performed on Ubuntu (including OpenGL code), Windows (except OpenGL code) and Mac (except OpenGL code). Manual testing is performed in Ubuntu and Windows.
